...
import uk.ac.city.aczh716.StudentWebsite.services.ProfileService;
...
public class ProfileController {
     ...
     * to each of the domain objects (StudentUser, UniversityApplication (as a list), LoginHistory (as a list)
     *
     */
     ...
     * for the current logged in user (user info, application list, login history list)
     */
